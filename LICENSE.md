...
- Include a link to the original repository: `https://github.com/qtremors/earnslate`
...
```
Based on Earnslate by [Tremors](https://github.com/qtremors)
https://github.com/qtremors/earnslate
```
